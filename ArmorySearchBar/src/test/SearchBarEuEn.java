...
public class SearchBarEuEn {
    //Search Bar Europe Region with English language
    @Test
...
// Step 1. GO TO THE ARMORY WOWS URL EUROPE & ENGLISH
        driver.get("https://armory.worldofwarships.com/en/");
        ...
        //Are we are the correct URL?
        Assert.assertEquals("https://armory.worldofwarships.com/en/", driver.getCurrentUrl());
